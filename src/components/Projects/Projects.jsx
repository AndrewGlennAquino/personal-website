    ...
    <section id="projects">
      ...
      >
        ...
        <Project
          ...
          description={
            "Delivered a responsive website for a local entrepreneur’s gym business in Mazamitla, Mexico. Built using React.js, Tailwind CSS, Motion, and Google Maps API, focusing on bold fonts and fast animations for a sporty aesthetic. Deployed using Github Pages and a custom domain from Cloudflare, ensuring security and no overhead expense to the owner."
          }
          image={fitHausHero}
